const fdc3Version = '2.0';
const fdc3AgentProviderName = 'Flugelbinder FDC3 Desktop Agent';
const fdc3AgentProviderVersion = '7.0.0';
const simulatedBootstrapDelayMs = 0;

// FDC3 Desktop Agent factory function
const fdc3AgentFactory = async (serviceUrl) => {
